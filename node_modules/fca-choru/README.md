...
# Unofficial Facebook Chat API By Ramake Choru TikTokers 
<a href="https://www.npmjs.com/package/fca-noder"><img alt="npm version" src="https://img.shields.io/npm/v/fca-noder.svg?style=flat-square"></a>
<img alt="version" src="https://img.shields.io/github/package-json/v/KurumiDevz/fca-noder?label=github&style=flat-square">
<a href="https://www.npmjs.com/package/fca-noder"><img src="https://img.shields.io/npm/dm/fca-noder.svg?style=flat-square" alt="npm downloads"></a>
...
## Install
If you just want to use fca-choru, you should use this command:
```bash
npm install fca-Choru
```
It will download `fca-Choru` from NPM repositories

### Bleeding edge
If you want to use bleeding edge (directly from github) to test new features or submit bug report, this is the command for you:
```bash
npm install ChoruTiktokers182/fca-choru or npm i git+https://github.com/ChoruTiktokers182/fca-Choru
```
