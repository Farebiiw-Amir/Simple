...
module.exports.onLogger = (str,end,ctscolor) => { 
	...
	if (ctscolor.indexOf('#') != 1) {
		console.log(chalk.hex('#00CCCC').bold(`${end || '[ FCA-CHORU ]'} > `) + str);
	}
	else if (!isNaN(checkbutdak)) {
		console.log(chalk.hex(ctscolor).bold(`${end || '[ FCA-CHORU ]'} > `) + str);
	} 
	else console.log(chalk.hex('#00CCCC').bold(`${end || '[ FCA-CHORU ]'} > `) + str);
}
