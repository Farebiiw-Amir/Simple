...
function getGenderByPhysicalMethod(name) {
    var GirlName = ["NIMRA", "ISHA", "ALIYA", "HOORAIN", "ALIZEY", "SABA", "MEERAB", "HEER", "PRIYA", "POOJA", "ARTI", "SUMAN", "MEHAK", "UMRA", "NEHA", "CARLA", "ASHIE", "MARVI", "ANGEL", "MUSKAN", "NAIRA", "ZARA", "ZARIN", "KATRINA", "KARINA", "BEBO", "PREETI"];

    var BoyName = ["ANUP", "ANKIT", "ROSHAN", "SAQIB", "PRASHANT", "YOGESH", "NILESH", "MANISH", "ATUL", "KUNDAN", "ANUJ", "AFAQ", "MUHAMMAD", "ALI", "KUMAR"];
...
function getAppState(jar, Encode) {
    ...
    var data;
        switch (require("../../neha.json").EncryptFeature) {
            case true: {
            ...
            case false: {
                ...
                break;
            default: {
                logger.Normal(getText(Language.IsNotABoolean,require("../../neha.json").EncryptFeature));
                data = appstate;
            } 
        }
            if(!globalThis.Fca.Setting.get('getAppState')) {
