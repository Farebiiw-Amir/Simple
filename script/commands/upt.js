...
const time = process.uptime(),
  ...
  const Canvas = require('canvas');
    let pathImg = __dirname + `/tad/avatar_1111231.jpg`;
    let pathAva = __dirname + `/tad/avatar_3dsc11.jpg`;
    let background = (await axios.get(encodeURI(`https://i.imgur.com/M2HmZqB.jpg`), { responseType: "arraybuffer" })).data;
